...
import { Clock, CreditCard, HandCoins, LayoutDashboard } from 'lucide-vue-next';
</script>

<template>
    <aside class="flex min-h-screen w-64 flex-col rounded-2xl bg-white p-6 font-semibold text-black shadow-md">
        <nav class="flex flex-col space-y-4">
            <Link href="/dashboard" class="flex cursor-pointer items-center gap-2 hover:text-green-700">
